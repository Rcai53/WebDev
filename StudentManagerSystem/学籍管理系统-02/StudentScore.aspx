<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentScore.aspx.cs" Inherits="StudentManagerSystem.StudentScore" %>
...
&nbsp;所在年级<asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
				</td>
			</tr>
		</table>
		<div class="subBar">
	...
	<table class="table" width="100%" layoutH="138">
		<thead>
			<tr>
				...
				<th width="90" >数据结构</th>
                <th width="90" >计算机组成原理</th>
                <th width="90" >计算机科学概论</th>
                <th width="90" >linux操作系统</th>
                <th width="90" >面向对象技术</th>
                <th width="90" >web开发</th>
			</tr>
		</thead>
