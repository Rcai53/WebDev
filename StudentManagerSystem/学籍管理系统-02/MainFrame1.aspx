<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainFrame1.aspx.cs" Inherits="StudentManagerSystem.MainFrame1" %>
...
<table class="table" width="100%" layoutH="30">
		<thead>
			 <tr>
				...
				<th width="80" >计算机</th>
                <th width="80" >ASP编程</th>
                <th width="80" >英语</th>
                <th width="80" >C#开发</th>
                <th width="80" >Android开发</th>
                <th width="80" >实践应用</th>
...
使用过程中任何疑问请联系柯冠舟
	...
	<div id="footer">Copyright © 2017 柯冠舟</div>
